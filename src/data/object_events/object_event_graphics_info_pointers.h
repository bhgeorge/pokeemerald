...
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Mon_Poochyena;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Mon_Ralts;
