static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_DEBUGBURGH - 1] = {MAP_GROUP(DEBUGBURGH), MAP_NUM(DEBUGBURGH), 10, 10},
    [HEAL_LOCATION_WAKEBOROUGH - 1] = {MAP_GROUP(WAKEBOROUGH), MAP_NUM(WAKEBOROUGH), 27, 9},
    [HEAL_LOCATION_FOXBOURNE - 1] = {MAP_GROUP(FOXBOURNE), MAP_NUM(FOXBOURNE), 21, 15},
};
