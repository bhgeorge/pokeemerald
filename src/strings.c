...
const u8 gText_EverRepelOn[] = _("Turned on the Ever Repel.\pWild POKéMON will be repelled.{PAUSE_UNTIL_PRESS}");
const u8 gText_EverRepelOff[] = _("Turned off the Ever Repel.\pWild POKéMON will no longer be repelled.{PAUSE_UNTIL_PRESS}");
const u8 gText_EverLureOn[] = _("Turned on the Ever Lure.\pRare POKéMON are more likely to appear.{PAUSE_UNTIL_PRESS}");
const u8 gText_EverLureOff[] = _("Turned off the Ever Lure.\pNearby POKéMON went back to normal.{PAUSE_UNTIL_PRESS}");
