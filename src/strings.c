...
const u8 gText_ExpShareTurnOn[] = _("Turned on the EXP. SHARE.\pAll party POKéMON will\nnow gain EXP Points.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareTurnOff[] = _("Turned off the EXP. SHARE.\pEXP Points will not\nbe shared.{PAUSE_UNTIL_PRESS}");
const u8 gText_EverRepelTurnOn[] = _("Turned on the EVER REPEL.\pWild POKéMON will be repelled.{PAUSE_UNTIL_PRESS}");
const u8 gText_EverRepelTurnOff[] = _("Turned off the EVER REPEL.\pWild POKéMON will no\nlonger be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnSkillsEv[] = _("POKéMON EV");
const u8 gText_PkmnSkillsIv[] = _("POKéMON IV");
...
const u8 gText_PorygonAndPrice[] =     _("PORYGON DOLL 6,500 COINS");
