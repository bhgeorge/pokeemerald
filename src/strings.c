...
const u8 gText_ExpShareTurnOn[] = _("Turned on the EXP. SHARE.\pAll POKéMON will now gain EXP Points.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareTurnOff[] = _("Turned off the EXP. SHARE.\pEXP Points will no longer be shared.{PAUSE_UNTIL_PRESS}");
const u8 gText_EverRepelTurnOn[] = _("Turned on the EVER REPEL.\pWild POKéMON will be repelled.{PAUSE_UNTIL_PRESS}");
const u8 gText_EverRepelTurnOff[] = _("Turned off the EVER REPEL.\pWild POKéMON will no longer be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnEv[] = _("POKéMON EV");
const u8 gText_PkmnIv[] = _("POKéMON IV");
...
const u8 gText_FollowerSlide[] = _("FOLLOWER SLIDE");
