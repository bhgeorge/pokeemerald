...
static const u8 sText_PkmnGainedEXPOther[] = _("Your other POKéMON\ngained {B_BUFF3} EXP Points.\p");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_PKMNGAINEDEXPOTHER - BATTLESTRINGS_TABLE_START] = sText_PkmnGainedEXPOther,
