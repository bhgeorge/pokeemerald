...
const struct SpritePalette sFogSpritePalette = {gFogPalette, GFXTAG_FOG_H};
const struct SpritePalette sCloudsSpritePalette = {gCloudsWeatherPalette, GFXTAG_CLOUD};
    ...
    if (!gWeatherPtr->fogHSpritesCreated)
    {
        ...
        for (i = 0; i < NUM_FOG_HORIZONTAL_SPRITES; i++)
        {
            ...
            if (spriteId != MAX_SPRITES)
            {
                ...
                sprite->oam.paletteNum = gWeatherPtr->colorMapIndex;
            }
            else
            {
