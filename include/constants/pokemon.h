...
// Shiny odds
#define SHINY_ODDS 1365 // Actual probability is SHINY_ODDS/65536
...
#define MAX_LEVEL_DIFF_PRE_EVO   1
...
#define EVO_LINK_AND_HOLD   16 // Link Stone is used on Pokémon while it's holding the specified item
