...
#define MAP_FORTREE_JUNGLE      (57 | (0 << 8))
...
#define MAP_FALLARBOR_TOWN_HYPER_TRAINERS_HOUSE    (8 | (5 << 8))
...
#define MAP_SHOAL_CAVE_ICE_ROOM_EXPANSION            (108 | (24 << 8))
#define MAP_NEW_MAUVILLE_EXPANSION                   (109 | (24 << 8))
